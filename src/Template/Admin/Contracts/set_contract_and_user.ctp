   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-md-8 col-md-offset-2">
            <div class="card">
               <div class="header">
                  <h4 class="title"><?= __('Add Contract & User') ?></h4>
               </div>
               <div class="content">
                  <div class="row">
                     <div class="col-sm-12">
                        ...
                        echo $this->Form->input('user.email', ['value'=>$announce['email'], 'class'=>'form-control', 'label'=>'User Email To Create']);
                        echo $this->Form->input('user.group_id', ['value'=>$announce['email'], 'class'=>'form-control', 'label'=>'User Group']);
                        echo $this->Form->input('announce.status', [
                           'type'=>'select',
                           'options'=>[
                              'ONLINE'=>'ONLINE',
                              'WAITING' => 'WAITING',
