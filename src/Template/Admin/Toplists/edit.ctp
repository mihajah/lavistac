      ...
      <div class="collapse navbar-collapse">
         <ul class="nav navbar-nav navbar-right">
            <li><?= $this->Form->postLink(
               __('Delete'),
               ['action' => 'delete', $toplist->id],
               ['confirm' => __('Are you sure you want to delete # {0}?', $toplist->id)]
               )?>
            </li>
   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-md-8 col-md-offset-2">
            <div class="card">
               <div class="header">
                  <h4 class="title"><?= __('Edit Toplist') ?></h4>
               </div>
               <div class="content">
                  <div class="header">
                     <?=$this->Html->image($toplist->pic_url, ['class'=>'img-responsive center-block'])?>
                  </div>
                  <div class="row">
                     <div class="col-sm-12">
