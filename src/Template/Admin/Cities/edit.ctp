<nav class="navbar navbar-default">
   <div class="container-fluid">
      ...
      <div class="navbar-header">
         ...
         <a class="navbar-brand" href="#"><?= __('Cities') ?></a>
      </div>
   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-md-8 col-md-offset-2">
            <div class="card">
               <div class="header">
                  <h4 class="title"><?= __('Edit City') ?></h4>
               </div>
               <div class="content">
                  <div class="row">
                     <div class="col-sm-12">
                        <?= $this->Form->create($city, ['novalidate']) ?>
                        <?php
                                                         echo $this->Form->input('name', ['class'=>'form-control']);
                                                                  echo $this->Form->input('slug', ['class'=>'form-control']);
                                                                     echo $this->Form->input('state_id', ['options' => $states,  'class'=>'form-control']);
                                                                                                   echo $this->Form->input('announces._ids', ['options' => $announces, 'class'=>'form-control']);
                                                         ?>
                     </div>
                  </div>
                  <hr>
