<nav class="navbar navbar-default">
   <div class="container-fluid">
      ...
      <div class="navbar-header">
         ...
         <a class="navbar-brand" href="#">Category - <?=h($category->name) ?></a>
      </div>
         ...
         <div class="col-md-8 col-md-offset-2">
            <div class="card">
               ...
               <div class="content">
                  ...
                  <?php if (!empty($category->announces)): ?>
                     <table class="table table-hover table-striped">
                        <tr>
                                                      <th scope="col"><?= __('Id') ?></th>
                                                      <th scope="col"><?= __('Created') ?></th>
                                                      ...
                                                      <th scope="col"><?= __('Old Announce Number') ?></th>
                        ...
                        <?php foreach ($category->announces as $announces): ?>
                           <tr>
                              ...
                              <td><?= h($announces->old_announce_number) ?></td>
