...
class NotificationsController extends AppController
{
   ...
   public function testSend(){
      if ($this->request->is('post')) {
         $notification = $this->Notifications->get($this->request->data['notification_id'], [
             'contain' => []
         ]);
         $this->getMailer('User')->send('notification', [$this->request->data['to'], $notification->subject, $notification->message]);
