...
use App\View\Cell\BannersCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\BannersCell Test Case
 */
class BannersCellTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->Banners = new BannersCell($this->request, $this->response);
    }
