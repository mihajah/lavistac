...
use App\View\Cell\OnlineCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\OnlineCell Test Case
 */
class OnlineCellTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->Online = new OnlineCell($this->request, $this->response);
    }
