 ...
 *
 */
class PicsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_pics_announces1' => ['type' => 'index', 'columns' => ['announce_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_pics_announces1' => ['type' => 'foreign', 'columns' => ['announce_id'], 'references' => ['announces', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
